    ...
    def create_networks(self,network_name,subnet_name,IP,gateway):
        try:
            ...
            if network_name not in networks:
                ...
                print("network {} already exists ".format(network_name))
            os.system('openstack network show ' + network_name)
            
            subnet = os.popen('openstack subnet list').read()
            if subnet_name not in subnet:
                ...
                print("Subnet {} already exists ".format(network_name))
            
            os.system('openstack subnet show ' + subnet_name)
...
def create_router(subnet_name):
    try:
        ...
        if router_name not in routers:
            print("Creating a Router {}".format(router_name))
